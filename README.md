...
An opinionated quick start [Create React App](https://github.com/facebook/create-react-app)with  **Redux**, **TypeScript**, **React Router**, **Enzyme** and custom **ESlint** configuration. 
## Usage
